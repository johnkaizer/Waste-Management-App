...
public class UsersSubscriptionsFragment extends Fragment {
    ...
    private List<Subscription> getSampleSubData() {
        ...
        subscriptions.add(new Subscription("50", "Premium Plan",  "Daily trash pickup\n" +
                "Hazardous waste disposal\n" +
                "Exclusive customer support hotline\n" +
                "Complimentary waste audit"));
        subscriptions.add(new Subscription("100", "Business Eco Bundle",  "Waste reduction consultation\n" +
                "Commercial recycling services\n" +
                "Quarterly sustainability reports\n" +
                "Employee environmental training"));
        subscriptions.add(new Subscription("4", "Family Plan",  "Multiple waste bin options\n" +
                "Monthly bulk item pickup\n" +
                "Exclusive family-friendly recycling workshops"));
        subscriptions.add(new Subscription("150", "Community Cleanup",  "Community-wide cleanup events\n" +
                "Educational seminars\n" +
                "Discounted rates for neighborhood participants"));
        subscriptions.add(new Subscription("300", "Tech Recycling Add-On",  "Electronic waste pickup\n" +
                "Secure data destruction\n" +
                "Annual gadget recycling event"));
        subscriptions.add(new Subscription("4", "Student Sustainability Pack",  "Bi-monthly waste reduction challenges\n" +
                "Student-exclusive eco-friendly merchandise\n" +
                "Green campus initiatives updates"));
        subscriptions.add(new Subscription("800", "Zero-Waste Warrior",  "Advanced recycling options\n" +
